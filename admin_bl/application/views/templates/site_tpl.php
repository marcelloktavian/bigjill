...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('/assets/plugins/DataTables/css/dataTables.bootstrap4.min.css'); ?>" media="screen" />
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('/assets/plugins/jquery-ui/jquery-ui.css'); ?>" media="screen" />
	...
	<script type="text/javascript" src="<?php echo base_url('/assets/plugins/DataTables/js/dataTables.bootstrap4.min.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('/assets/plugins/sweetalert/sweetalert2.all.min.js'); ?>"></script>
