                  ...
                  <!--  -->
                        ...
                        <input type="hidden" name="admin_id" value="<?= $detail->admin_id ?>">
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="keterangan" class="form-control" id="keterangan" aria-describedby="keterangan" cols="30" rows="5"><?= $detail->keterangan ?></textarea>
                          </div>
