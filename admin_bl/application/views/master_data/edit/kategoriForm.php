...
<div class="container-fluid" id="container-wrapper">
              <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="ukuran.html">Kategori</a></li>
                  ...
                  <!--  -->
                        ...
                        <input type="hidden" name="kategori_id" value="<?= $detail->kategori_id ?>">
                          <div class="form-group">
                            ...
                            placeholder="Nama Kategori" value="<?= $detail->nama ?>">
                          </div>
                          <div class="form-group">
                            <label for="singkatan">Menggunakan Ukuran</label>
                            <select name="opsiUkuran" class="form-control" id="opsiUkuran" aria-describedby="Menggunakan Ukuran">
                                <option value="<?= $detail->ukuran ?>"><?= $detail->ukuran == "Y" ? "YA" : "TIDAK" ?></option>
