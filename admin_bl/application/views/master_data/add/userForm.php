          ...
          <div class="card-body">
            ...
            <form method="POST" action="<?= site_url('Master_Data/addUser') ?>">
              <div class="form-group">
                ...
                placeholder="Nama" maxlength="60" required autofocus>
              </div>
              <div class="form-group">
                <label for="username">Username</label>
                <input type="text" class="form-control" name='username' id="username" aria-describedby="username"
                placeholder="Username" minlength="6" maxlength="8" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea name="keterangan" class="form-control" id="keterangan" aria-describedby="keterangan" cols="30" rows="5" placeholder="Keterangan"></textarea>
              </div>
