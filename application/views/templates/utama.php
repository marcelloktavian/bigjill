...
<!--/banner-->
<div class="banner-info" style="z-index: 3;">
  <h3 class="mb-4"  style="z-index: 3;">BigJill Catalog</h3>
  <div class="ban-buttons" style="z-index: 3;">
    <a href="#catalog" class="btn"  style="z-index: 3;">Lihat Catalog</a>
  </div>
</div>
<!--// banner-inner -->
</div>
...
<a name="catalog">
  <section class="ab-info-main py-md-3 py-3"></a>
   <div class="container py-md-10"><br>
